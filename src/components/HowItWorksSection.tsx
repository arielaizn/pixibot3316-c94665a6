...
const HowItWorksSection = () => {
  ...
  const steps = [
    { icon: UserPlus, title: t("howItWorks.step1") },
    { icon: MessageSquare, title: t("howItWorks.step2") },
    { icon: Video, title: t("howItWorks.step3") },
  ];
  ...
  return (
    <section className="py-20">
      <div className="container mx-auto px-4">
        <ScrollReveal>
          <h2 className="mb-16 text-center text-3xl font-bold text-foreground md:text-4xl">{t("howItWorks.title")}</h2>
        </ScrollReveal>
            ...
            <div key={i} className="flex items-center">
              <ScrollReveal delay={i * 0.15} direction="up">
                <div className="flex flex-col items-center text-center">
                  ...
                  <span className="mb-1 text-sm font-bold text-primary">{t("howItWorks.step")} {i + 1}</span>
