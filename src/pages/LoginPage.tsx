      ...
      <div className="w-full max-w-md">
        ...
        <div className="rounded-2xl border border-border bg-card p-8 shadow-lg">
          <div className="mb-6 text-center">
            <h1 className="text-2xl font-bold text-foreground">התחבר לחשבון שלך</h1>
            <p className="mt-2 text-sm text-muted-foreground">חזור להמשיך ליצור סרטוני AI</p>
          </div>
          ...
          <p className="mt-6 text-center text-sm text-muted-foreground">
            אין לך חשבון עדיין?{" "}
            <Link to="/signup" className="font-semibold text-primary hover:underline">הירשם</Link>
          </p>
        </div>
      </div>
    </div>
