...
import {
  LayoutDashboard, Users, CreditCard, Film, FolderOpen, MessageCircle, Shield, LogOut, Loader2, Menu, Gift, BarChart3, Bell, ShieldCheck, Trophy, GraduationCap,
} from "lucide-react";
...
const navItems = [
  ...
  { path: "/admin/challenges", icon: Trophy, labelKey: "admin.nav.challenges" as const },
  { path: "/admin/academy", icon: GraduationCap, labelKey: "admin.nav.academy" as const },
