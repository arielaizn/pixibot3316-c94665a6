...
export default function LessonViewerPage() {
  ...
  return (
    <div className="flex min-h-screen bg-background" dir={direction}>
      ...
      {/* Sidebar */}
      <aside
        className={`fixed inset-y-0 ${isRTL ? "right-0" : "left-0"} z-30 w-80 flex flex-col border-e border-border bg-card transition-transform duration-200 lg:relative lg:translate-x-0 ${
